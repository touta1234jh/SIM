...
class Motpasseoublier extends StatefulWidget {
  const Motpasseoublier({super.key});

  @override
  State<Motpasseoublier> createState() => _MotpasseoublierState();
}

class _MotpasseoublierState extends State<Motpasseoublier> {
  ...
  void _submit() {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Renitilisation réussie (simulée)")),
      );
    } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Renitialiser le mot de passe"),
      ),
      body: ListView(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: const Text("Renitialiser le mot de passe"),
                  ),
                ),
